...
const IVFSuccesCalculator = () => {
    ...
    const handleCyclePress = (cycle) => {
        ...
        if (cycle === 'Cycle 1') {
            navigation.navigate('IVFCycle1Screen');
        }
        if (cycle === 'Cycle 2') {
            navigation.navigate('IVFCycle2Screen');
        }
        if (cycle === 'Cycle 3') {
            navigation.navigate('IVFCycle3Screen');
        }
    };
...
export default IVFSuccesCalculator;
