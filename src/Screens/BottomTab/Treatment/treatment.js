...
import AppColors from '../../../utils/appColors/index';
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <Text style={styles.title}>Determine your IVF cycle</Text>
          ...
          <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('Pharmaceutical')}>
            <Image
          ...
          <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('Laboratory')}>
            <Image
          ...
          <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('UltrasoundScan')}>
            <Image
          ...
          <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('ScanReport')}>
            <Image
