        ...
        <View style={styles.container}>
            ...
            <View style={styles.infoContainer}>
                ...
                <View style={styles.circlesRow}>
                    <TouchableOpacity style={styles.greenCircle} onPress={() => navigation.navigate('EmbyroEgg')}>
                        <Image
                    ...
                    <TouchableOpacity style={styles.greenCircle} onPress={() => navigation.navigate('PregnancyScan')}>
                        <Image
                            source={require('../../../../assets/images/labs.png')} 
                            style={styles.circleImage}
                        />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.greenCircle} onPress={() => navigation.navigate('MedicationReminder')}>
                        <Image
                ...
                {/* <View style={styles.textButtonsRow}>
                    <TouchableOpacity style={styles.iconButton}>
                        <Text style={styles.iconLabel}>Embryo & Eggs</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.iconButton}>
                        <Text style={styles.iconLabel}>U/S</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.iconButton}>
                        <Text style={styles.iconLabel}>Labs</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.iconButton}>
                        <Text style={styles.iconLabel}>Meds</Text>
                    </TouchableOpacity>
                </View> */}
            </View>
        </View>
